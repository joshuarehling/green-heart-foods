...
class User {
    ...
    public function get_login_form($context) {
        return <<<HTML
            ...
            <p class="login_note">
                Having trouble? <br />Please contact your us at <a href="tel:+4158008910">415-800-8910</a><br />or <a href="mailto:lisa@greenheartfoods.com">lisa@greenheartfoods.com</a>
            </p>
HTML;
    }
}